...
const categories: Category[] = [
    ...
    { id: 4, name: '이혼', description: '부부가 합의 또는 재판에 의하여 혼인 관계를 인위적을 소멸시키는 행위' },
...
const CategoryPage: React.FC = () => {
    ...
    return (
        <div className="bg-black bg-category-image bg-cover bg-center min-h-screen flex flex-col items-start p-4 relative">
            ...
            <button className="bg-arrow-image bg-no-repeat bg-contain w-full h-[5vh] flex flex-col imtes-start mt-7 ml-5" style={{ maxWidth: '3rem' }} onClick={handleButtonClick}></button>

            {/* 이미지 + Category + Skip > */}
            <div className="w-full mx-auto flex justify-start text-white items-center " style={{ maxWidth: '97rem' }}>
            ...
            <p className="w-full mx-auto flex justify-start mb-8 text-white text-2xl font-sans font-normal" style={{ maxWidth: '97rem' }}>
